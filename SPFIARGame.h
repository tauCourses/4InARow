...
#define SP_FIAR_GAME_OUT_OF_TABLE '#'
...
/**
* Check a pattern in the gameBoard
* @param src - the source game
* @param starti,startj - the most upper left point to check
* @param endi,endj - the most bottom right point to check
* @param diri,dirj - the  direction of the pattern
* @param len - the len of the pattern to check
* @return
* SP_FIAR_GAME_PLAYER_1_SYMBOL - if player 1 fullfill the pattern
...
* @param i, j position
* @return
* if i<0 or i>= SP_FIAR_GAME_N_ROWS or j<0 or j>=SP_FIAR_GAME_N_COLUMNS return SP_FIAR_GAME_OUT_OF_TABLE
 ...
 * @param src - the source game
 * @param difficuly - an integer between 1-7 represent the difficulty
 */
